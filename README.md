...
# Transporta los datos – Videojuego Educativo
## Descripción
Este proyecto es un videojuego educativo creado en **Construct 3** para la asignatura de
**Informática Básica**.
El objetivo del juego es que el jugador aprenda a identificar y transportar correctamente los
datos principales desde un router hasta distintos receptores.
El juego incluye:
...
3. Crear una **variable global de puntuación**.
4- Cada acierto suma .
5- Se muestra en pantalla mediante un objeto de texto.
## Objetivos educativos
- Aprender sobre el transporte de los datos en la red y los peligros de los nodos peligrosos.
